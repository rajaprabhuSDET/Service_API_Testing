...
public class Product1Macro implements MacroInterface
{
	protected ExcelOperationsPOI sampleexcel=null;
	protected String Targetpath;
	protected Product1Macro trans;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	public Product1Macro(PropertiesHandle configFile) throws MacroException
	{
	...
	public void PumpinData(LinkedHashMap<String, String> inputData,PropertiesHandle configFile) throws MacroException
	{
		try
		{
			...
			trans= new Product1Macro(configFile);
